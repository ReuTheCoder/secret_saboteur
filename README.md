...
Orignally just meant to host one game, Secret Saboteur - A social deduction game. Now I hope to update it with more "Social party gameS" when I get the chance.

Secret Sabototeur Description:
...
One player is the Saboteur and tries to mislead the guesser.
  
Teammates win if the Guesser is correct or exposes the Saboteur.
